// Indiage: import { networkAdapter } from 'path/to/NetworkAdapter.js';
// Indiage: const response = await networkAdapter.get('/api/hotel/123');
// Indiage: const response = await networkAdapter.post('/api/hotel', { name: 'Hotel Name' });
